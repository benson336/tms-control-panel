      ...
      <div id="sidebar" class="bg-neutral-700 h-screen md:block shadow-xl px-3 overflow-x-hidden transition-transform duration-300 ease-in-out" x-show="sidenav" style={{"width":"12%"}}>
        <div class="space-y-6 md:space-y-10 mt-10">
          <div id="profile" class="space-y-3">
            ...
            />*/}
            <div><h2 class="font-black text-5xl md:text-5xl text-center text-white">U N I S</h2></div>
          </div>
          
          <div id="menu" class="flex flex-col space-y-2">
            <a
              href=""
              class="text-base font-medium text-white py-2 px-2 hover:bg-gray-600 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out text-left"
            >
              <svg
              ...
              <span class="ml-2">Window Checkin</span>
            </a>
            <a
              href=""
              class="text-base font-medium text-white py-2 px-2 hover:bg-gray-600 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out text-left"
            >
              <svg
                class="w-6 h-6 fill-current inline-block"
                fill="currentColor"
            ...
            >
              ...
              <span class="ml-2">Billing Records</span>
            </a>
  ...
  {/*<div className="w-full h-full">
            <dh-component>
                <div className="flex flex-no-wrap">
                    ...
                    <div style={{"minHeight": "100vh"}} className="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
                        <div className="px-8">
        ...
        <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                <a href="/" className="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                    <span className="fs-5 d-none d-sm-inline">UNIS</span>
                </a>
                <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <li className="nav-item">
                        <a href="#" className="nav-link align-middle px-0">
                            <i className="fs-5 bi-house"></i> <span className="ms-1 d-none d-sm-inline">Transport</span>
                        </a>
                    </li>
                    <li>
                        <a href="#submenu1" data-bs-toggle="collapse" className="nav-link px-0 align-middle">
                            <i className="fs-5 bi-speedometer2"></i> <span className="ms-1 d-none d-sm-inline">Terminals</span> </a>
                    ...
                    <li>
                        <a href="#" className="nav-link px-0 align-middle">
                            <i className="fs-5 bi-table"></i> <span className="ms-1 d-none d-sm-inline">Message</span></a>
                    </li>
